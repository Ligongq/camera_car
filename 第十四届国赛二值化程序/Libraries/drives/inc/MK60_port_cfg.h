...
//      模块通道        端口      可选范围                建议
#define FTM1_CH0_PIN    B0       //A8、A12、B0
#define FTM1_CH1_PIN    B1       //A9、A13、B1
...
//正交解码模块通道      端口      可选范围                建议
#define FTM1_QDPHA_PIN  B0       //A8、A12、B0
#define FTM1_QDPHB_PIN  B1       //A9、A13、B1
